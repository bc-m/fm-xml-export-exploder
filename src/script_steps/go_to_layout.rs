...
mod tests {
    ...
    fn test_layout() {
        ...
        let expected_output =
            Some(r#"Gehe zu Layout [ Layout: "FooLayout" ; Animation: Ohne ]"#.to_string());
        assert_eq!(sanitize(xml.trim()), expected_output);
    }
    ...
    fn test_by_name() {
        ...
        let expected_output =
            Some(r#"Gehe zu Layout [ Layoutname: "Foo" ; Animation: Ohne ]"#.to_string());
        assert_eq!(sanitize(xml.trim()), expected_output);
    }
    ...
    fn test_by_number() {
        ...
        let expected_output =
            Some(r#"Gehe zu Layout [ Layoutnr.: "Bar" ; Animation: Ohne ]"#.to_string());
        assert_eq!(sanitize(xml.trim()), expected_output);
    }
}
