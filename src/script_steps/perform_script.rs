...
mod tests {
    ...
    fn test_without_parameter() {
        ...
        let expected_output = Some("Script ausführen [ Aus Liste ; \"Do something\" ]".to_string());
    ...
    fn test_with_parameter() {
        ...
        let expected_output = Some("Script ausführen [ Aus Liste ; \"Do something\" ; Parameter: cf_ScriptparameterSetzen ( \"CurlId\" ; $curl ) ]".to_string());
        assert_eq!(sanitize(xml_input.trim()), expected_output);
    }
    ...
    fn test_by_name_with_parameter() {
        ...
        let expected_output =
            Some("Script ausführen [ Nach Name ; \"Do something\" ; Parameter: 123 ]".to_string());
        assert_eq!(sanitize(xml_input.trim()), expected_output);
    }
}
